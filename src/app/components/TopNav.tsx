  ...
  return (
    <div className="sticky top-0 z-40 flex items-center justify-between h-[76px] px-4 md:px-8 shrink-0 border-b border-slate-900/10 bg-[#fbf7ef]/90 backdrop-blur-[22px]">
      ...
      <div className="flex items-center gap-2 md:gap-3 shrink-0">
        {/* Export button */}
        <button className="hidden sm:flex items-center gap-2 h-[42px] px-3 md:px-4 rounded-xl bg-gradient-to-b from-white/95 to-neutral-50/85 border border-slate-900/10 shadow-[0_10px_24px_rgba(15,23,42,0.06),inset_0_1px_0_rgba(255,255,255,0.92)] text-[#182033] text-[0.83rem] font-bold tracking-[-0.01em] hover:bg-neutral-50 transition-colors shrink-0">
          <Download size={15} />
          <span className="hidden lg:inline">Export</span>
        </button>

        {/* Notification */}
        <button className="relative flex items-center justify-center w-[38px] h-[38px] md:w-[42px] md:h-[42px] rounded-xl bg-white border border-slate-900/10 shadow-[0_8px_24px_rgba(15,23,42,0.06)] text-[#556174] hover:text-slate-900 transition-colors shrink-0">
          <Bell size={17} />
          <div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#f97316] border-2 border-white" />
        </button>

        {/* User Profile */}
        <button className="flex items-center gap-2 md:gap-2.5 h-[38px] md:h-[42px] pl-1.5 pr-1.5 sm:pr-2 md:pr-3.5 rounded-xl bg-white border border-slate-900/10 shadow-[0_8px_24px_rgba(15,23,42,0.06)] hover:bg-slate-50 transition-colors shrink-0">
          ...
          <div className="hidden sm:block text-left">
            <div className="text-[0.81rem] font-bold text-[#182033] tracking-[-0.02em] leading-none">
              Admin
            </div>
            <div className="text-[0.70rem] font-semibold text-[#556174] mt-0.5">
              Treasurer
            </div>
          </div>
